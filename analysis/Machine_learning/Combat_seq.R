...
### TCGA-OV + JGOG
##############################################
in_df1=fread('../data/TCGA-OV_555_ascat_spmg.CNV48.matrix.tsv'
             ,data.table = F)
...
out_df1="../data/TCGA-OV_555_ascat_spmg.CNV48.matrix.combat_to_JGOG.tsv"
out_df2="../data/JGOG_282_ascat_spmg.CNV48.matrix.combat_to_TCGA-OV.tsv"
...
### TCGA-OV+UCEC + JGOG
##############################################
in_df3=fread('../data/TCGA-UCEC_176_ascat_spmg_CNV48.matrix.tsv'
             ,data.table = F)
...
out_df3="../data/TCGA-OV-UCEC_731_ascat_spmg_CNV48.matrix.combat_to_JGOG.tsv"
out_df4="../data/JGOG_282_ascat_spmg.CNV48.matrix.combat_to_TCGA-OV-UCEC.tsv"
